    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-80 bg-white border-r border-gray-200 p-6 overflow-y-auto">
        ...
        <div className="bg-gray-100 rounded-lg p-4 mb-6">
          <h3 className="text-sm font-semibold text-gray-700 mb-2">The Problem</h3>
          <img
      ...
      <div className="flex-1 flex flex-col">
        <div className="bg-white border-b border-gray-200 p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className={`w-10 h-10 bg-gradient-to-br ${COGNALITIES[selectedCognality].color} rounded-full flex items-center justify-center mr-3`}>
                <Icon className="w-6 h-6 text-white" />
              </div>
              <div>
                <h2 className="font-semibold text-gray-900">{COGNALITIES[selectedCognality].name} AI Learner</h2>
                <p className="text-sm text-gray-500">Phase: {sessionMetrics.phase} • Turn {sessionMetrics.turnCount}</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <div className="text-right">
                <div className="text-sm font-medium text-gray-700">{deltaLearning}% Learned</div>
                <div className="text-xs text-gray-500">{resolvedLayers}/4 layers resolved</div>
              </div>
              <button
        ...
        <div className="bg-white border-t border-gray-200 p-4">
          <div className="flex items-end space-x-2">
            ...
            <button
              ...
              className={`p-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r ${COGNALITIES[selectedCognality].color} text-white hover:shadow-lg`}
            >
